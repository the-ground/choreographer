...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.395975, 0.453315, 0.982942, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-30",
					"maxclass" : "flonum",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 835.0, 785.0, 50.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.575386, 0.963332, 0.429603, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-19",
					"maxclass" : "flonum",
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 785.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 414.0, 10.0, 50.0, 20.0 ]
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.923005, 0.461864, 0.448329, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-12",
					"maxclass" : "flonum",
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 680.0, 785.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 353.0, 10.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 860.0, 56.0, 20.0 ],
					"text" : "pack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 310.0, 32.5, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 109.0, 31.0, 17.0 ],
					"text" : "load"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1185.0, 105.0, 40.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 109.0, 40.0, 17.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 35.0, 655.0, 94.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 935.0, 185.0, 105.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 815.0, 185.0, 105.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 685.0, 185.0, 105.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 85.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 470.0, 81.0, 17.0 ],
					"text" : "ignoreclick $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 470.0, 81.0, 17.0 ],
					"text" : "ignoreclick $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 470.0, 81.0, 17.0 ],
					"text" : "ignoreclick $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1055.0, 105.0, 112.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 105.0, 100.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 105.0, 36.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 710.0, 10.0, 36.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.0, 105.0, 47.0, 17.0 ],
					"text" : "size $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 870.0, 105.0, 66.0, 17.0 ],
					"text" : "range 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.0, 105.0, 80.0, 17.0 ],
					"text" : "setdomain $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 750.0, 700.0, 69.0, 20.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 35.0, 76.0, 45.226425 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 35.0, 656.0, 94.0 ],
					"size" : 5000.0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 784.5, 729.0, 759.0, 729.0, 759.0, 775.0, 769.5, 775.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 809.5, 729.0, 831.0, 729.0, 831.0, 774.0, 844.5, 774.0 ],
					"source" : [ "obj-5", 2 ]
				}
